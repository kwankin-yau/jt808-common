...
abstract class AbstractJT808MsgBodyEncoder[T <: JT808Msg](implicit classTag: ClassTag[T]) extends JT808MsgBodyEncoder {
  ...
  override def encBody(protoVer: Byte, adasDialect: AdasDialect, m: JT808Msg, out: ByteBuf): Unit = encodeBody(protoVer, adasDialect, m.asInstanceOf[T], out)
